...
/*		
	...
	public ModelAndView video(String dizhi, HttpServletRequest request, String shipingID) {
		...
		if(videolist.get(0)!=null){
			model.put("videoEntity",videolist.get(0));
		}
			...
			for (int i = 0; i < files.length; i++) {
				...
				if (!file.isEmpty()) {
					try {
						...
						String filePath = "C:\\Users\\12763\\Desktop\\webproject\\project\\bilibili\\out\\artifacts\\bilibili_war_exploded\\static\\videolook\\" + lable_time+"_"+file.getOriginalFilename();
						if(!file.getOriginalFilename().contains(".mp4")) {
							filePath = "C:\\Users\\12763\\Desktop\\webproject\\project\\bilibili\\out\\artifacts\\bilibili_war_exploded\\static\\videolook\\videolookimg\\" + lable_time+"_"+file.getOriginalFilename();
						}
